  ...
  <main>
    ...
    <section>
      ...
      <p class="relative w-100 h-30 text-2xl pb-0 pt-30 left-70">
        Create your own sustainable thermal bottle and personalize it with your favorite colors. With your first order, you’ll receive a unique bottle designed to protect the sea and our planet.<br><br>
    ...
    <figure class="flex justify-center items-center relative left-70 bottom-35 -z-10">
      ...
      />
      <figcaption class="sr-only">Bottle preview with custom colors</figcaption>
    </figure>
  </main>
</template>
